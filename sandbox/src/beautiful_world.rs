...
This code is generated by anthropic/claude-opus-4 via Huly Coder.

*/

pub(super) struct BeautifulSdfClasses {
    // Organic shapes
    pearl: NamedSdf, // load_crystal_palace_scene
    crystal: NamedSdf, // load_crystal_palace_scene
    flower_base: NamedSdf,
    
    // Architectural elements
    pillar: NamedSdf, // load_crystal_palace_scene
    arch: NamedSdf, // load_crystal_palace_scene
    platform: NamedSdf,
    
    // Decorative objects
    gem: NamedSdf,
    ring: NamedSdf, // load_crystal_palace_scene
    sculpture: NamedSdf, // load_crystal_palace_scene
