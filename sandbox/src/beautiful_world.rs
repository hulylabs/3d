...
pub(super) struct BeautifulWorldSdfClasses {
    // Organic shapes
...
pub(super) struct BeautifulWorldMaterials {
...
pub(super) struct BeautifulWorld {
    sdf_classes: BeautifulWorldSdfClasses,
    materials: BeautifulWorldMaterials,
    light_panel: Option<ObjectUid>,
}

impl BeautifulWorld {
    #[must_use]
    pub(super) fn new(sdf_classes: BeautifulWorldSdfClasses, materials: BeautifulWorldMaterials) -> Self {
        Self { 
            sdf_classes, 
            materials, 
            light_panel: None,
