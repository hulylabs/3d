    ...
    fn resumed(&mut self, event_loop: &ActiveEventLoop) {
        ...
        match window_creation {
            Ok(ware) => {
                ...
                let sphere_material = scene.add_material(&Material::new()
                ...
                scene.add_sphere(Point::new(1.5, 0.6, -1.0), 0.25, sphere_material);
                ...
                let large_box_location = Affine::from_nonuniform_scale(3.65, 0.8, 0.25) * Affine::from_translation(Vector::new(0.15, 0.6, -1.0));
